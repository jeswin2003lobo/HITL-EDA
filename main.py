...
st.set_page_config(page_icon="✨", page_title="HITL-EDA")
...
st.title("Welcome to HITL-EDA!")
# st.write('<div class="tagline">Unleash the Power of Data with HITL-EDA!</div>', unsafe_allow_html=True)
